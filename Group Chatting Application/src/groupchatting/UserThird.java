...
public class UserThird implements ActionListener, Runnable {
    ...
    UserThird() {
        ...
        JLabel name = new JLabel("Class Friends");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel status = new JLabel("Mehak,Kratika,Suhani");
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
//            by default align one after other
...
//    server se aaye message ko read
    public void run(){
        try{
            String msg = "";
            while(true){
